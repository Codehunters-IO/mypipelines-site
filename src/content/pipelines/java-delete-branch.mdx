---
title: "Java Delete Branch"
slug: "java-delete-branch"
stack: "java"
kind: "reusable"
type: "misc"
triggers: ["workflow_call"]
description: "DEPRECATED: Use shared-delete-branch.yml instead"
sourcePath: ".github/workflows/java-delete-branch.yml"
---

```yaml title=".github/workflows/java-delete-branch.yml"
# DEPRECATED: Use shared-delete-branch.yml instead
name: "[DEPRECATED] Java - Delete Merged Branch"
